...
`show_info` включает (любое число) или отключает (0) отображение информации о книге (по умолчанию отключено)
```bash
$ python main.py 10 22 1
```
...
```python
{'Бизнес путь: Amazon.com': {'author': 'Саундерс Ребекка',
                             'comments': ['Отличная книга!', 'Interesno.'],
                             'cover_link': '/shots/10.jpg',
